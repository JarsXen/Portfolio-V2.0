...
export default function Hero() {
  ...
  return (
    <section id="home" ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white perspective-1000 transition-colors duration-300 transform-gpu">
